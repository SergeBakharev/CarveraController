...
requirements = python3,kivy==2.3.1,pyserial==3.5,pyquicklz==1.4.1,filetype==1.2.0,numpy,android,charset-normalizer==2.1.1
...
icon.filename = %(source.dir)s/carveracontroller/icon.png
