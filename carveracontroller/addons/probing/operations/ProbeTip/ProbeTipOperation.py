...
class ProbeTipOperationBore(OperationsBase):
    ...
    def generate(self, input_config: dict[str, float]):
        ...
        super().apply_direction(ProbeTipParameterDefinitions.ProbeDepth.code, config, self.invert_direction)
    ...
    def get_missing_config(self, config: dict[str, float]):
        ...
        required_definitions = {
            name: value
            for name, value in ProbeTipParameterDefinitions.__dict__.items()
