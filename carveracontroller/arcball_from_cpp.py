...
def arcball_camera_update(
    ...
    if rclick_held:
        ...
        if dist0 <= arcball_radius:
            # initial click was on the arcball
            ...
            to_eye_unorm = [eye[0] - target[0], eye[1] - target[1], eye[2] - target[2]]
            to_eye_len = math.sqrt(
                to_eye_unorm[0] * to_eye_unorm[0]
                + to_eye_unorm[1] * to_eye_unorm[1]
                + to_eye_unorm[2] * to_eye_unorm[2]
            )
            to_eye = [to_eye_unorm[0] / to_eye_len, to_eye_unorm[1] / to_eye_len, to_eye_unorm[2] / to_eye_len]
            ...
            eye_m = [across[0], across[1], across[2], up[0], up[1], up[2], to_eye[0], to_eye[1], to_eye[2]]
    ...
    if midclick_held:
        ...
        to_eye_unorm = [eye[0] - target[0], eye[1] - target[1], eye[2] - target[2]]
        to_eye_len = math.sqrt(
            to_eye_unorm[0] * to_eye_unorm[0] + to_eye_unorm[1] * to_eye_unorm[1] + to_eye_unorm[2] * to_eye_unorm[2]
        )
        to_eye = [to_eye_unorm[0] / to_eye_len, to_eye_unorm[1] / to_eye_len, to_eye_unorm[2] / to_eye_len]
    ...
    eye_zoom = [look[0] * zoom_dist, look[1] * zoom_dist, look[2] * zoom_dist]
